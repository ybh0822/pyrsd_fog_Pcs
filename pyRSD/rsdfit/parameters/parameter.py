...
class Parameter(PickeableCache, lmfit.Parameter):
    """
    A subclass of :class:`lmfit.parameter.Parameter` to represent a generic parameter.

    The added functionality is largely the ability to associate a prior with the parameter.
